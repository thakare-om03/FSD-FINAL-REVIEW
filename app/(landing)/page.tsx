          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-5 lg:gap-16">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-white">HackThisIdea</span>
              </div>
...
function StepCard({ number, title, description }: { number: string; title: string; description: string }) {
  return (
    <div className="p-8 text-center border rounded-xl bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border-zinc-200 dark:border-zinc-800 hover:shadow-md transition-all hover:scale-105">
